"""DatasetCache implementation: load, store, quarantine, and publish."""
...
from benchmarks import dataset_cache_hf
...
class DatasetCache:
    ...
    def _resolve_hf_cache_target(
        ...
        resolved_revision = dataset_cache_hf.resolve_huggingface_revision(spec)
